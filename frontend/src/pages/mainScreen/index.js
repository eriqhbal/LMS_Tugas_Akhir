...
export {default as HtmlDasar} from "./HTML_Page/HtmlDasar";
export {default as HtmlLanjut} from "./HTML_Page/HtmlLanjut";
export {default as CssDasar} from "./CSS_page/CssDasar";
export {default as CssLanjut} from "./CSS_page/CssLanjut";
export {default as JsDasar} from "./JS_Page/Js_dasar";
