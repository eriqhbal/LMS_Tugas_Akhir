    ...
    <div className="z-50 absolute right-1 top-16 p-8 rounded-lg w-96 bg-slate-100">
      <div className="flex justify-between items-center">
        ...
        <Button
          ...
          borderRadius="50%"
          color="#166534"
          currentFunction={() => cancelClicked("userProfile")}
        />
      </div>

      <div className="mt-3 flex pb-3 border-b-2 border-green-900">
        <FaUser className="w-20 h-20  object-cover" />
        <div className="h-14 mt-4 pl-2 pr-8 ml-14 bg-emerald-800 rounded-md text-white">
          <p className="text-third text-base tracking-normal mt-1">
      ...
      <div className="md:h-10 bg-green-800 active:bg-green-700 rounded-sm overflow-hidden shadow-md text-third mt-3 w-[14rem]">
        <button
          type="button"
          className="uppercase h-10 text-sm w-full text-gray-200 hover:text-white text-start pl-3"
          onClick={changeDataPage}
        >
          Ubah Data
        </button>
      </div>
      ...
      <button
        ...
        className="text-center mt-12 w-[150px] py-1 flex justify-center items-center overflow-hidden text-xl mx-auto rounded-sm text-white  bg-red-800  hover:bg-red-700 active:bg-red-600 focus:outline-none focus:ring focus:ring-red-900"
      >
